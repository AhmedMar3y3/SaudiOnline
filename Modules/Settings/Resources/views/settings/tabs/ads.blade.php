<x-layout :title="trans('settings::settings.tabs.ads')" :breadcrumbs="['dashboard.settings.index']">
  ...
  @component(layout('dashboard').'components.box')
      ...
      @slot('title', trans('settings::settings.tabs.ads'))

      @include('settings::settings.partials.ads-form')
