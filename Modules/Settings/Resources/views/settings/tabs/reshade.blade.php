<x-layout :title="trans('settings::settings.tabs.reshade')" :breadcrumbs="['dashboard.settings.index']">
  ...
  @component(layout('dashboard').'components.box')
      ...
      @slot('title', trans('settings::settings.tabs.reshade'))

      @include('settings::settings.partials.reshade-form')
