...
use Modules\Settings\Transformers\BaseSectionSettingResource;
use Modules\Support\Traits\ApiTrait;
use Modules\Settings\Entities\Setting;
use Modules\Settings\Transformers\SettingResource;
use Modules\Settings\Transformers\AdsSettingResource;
...
//    }
    ...
    {
        $data = new AdsSettingResource(Setting::class);
        return $this->sendResponse($data, 'success');
    }
     ...
     * @return JsonResponse
     */
    public function reshade(): JsonResponse
    {
        $data = new BaseSectionSettingResource(Setting::class);
        return $this->sendResponse($data, 'success');
    }
}
