export default {
  ar: {
    ...
    customers: {
      ...
      messages: {
        ...
        images_note:
          "الملفات المدعومة: jpeg ، png ، jpg | الحد الأقصى لحجم الملف: 10 ميجا بايت",
      },
      attributes: {
        name: "اسم العميل",
        phone: "رقم الهاتف",
    ...
    settings: {
      ...
      notes: {
        social_facebook:
          "برجاء كتابة اليورز نيم بعد (https://www.facebook.com/) وبرجاء عدم حذف الرابط",
        social_twitter:
          "برجاء كتابة اليورز نيم بعد (https://www.twitter.com/) وبرجاء عدم حذف الرابط",
        social_instagram:
          "برجاء كتابة اليورز نيم بعد (https://www.instagram.com/) وبرجاء عدم حذف الرابط",
        social_youtube:
          "برجاء كتابة اليورز نيم بعد (https://www.youtube.com/) وبرجاء عدم حذف الرابط",
        keywords:
          "الرجاء كتابة الكلمات الرئيسية مفصولة بعلامة (,) على سبيل المثال (واحد,اثنان, ثلاثة,...,...,إلخ)",
      },
      tabs: {
        main: "اعدادات الموقع",
    ...
    admin: {
      auth: {
        ...
        login: {
          ...
          chosen_password: " كلمة المرور المختاره",
        },
        register: {
          title: "انشاء حساب",
          name: "الاسم",
      ...
      environment: {
        ...
        wizard: {
          ...
          form: {
            ...
            app_force_https: "Use HTTPS protocol",
            app_force_https_true: "Yes",
            app_force_https_false: "No",
    ...
    install: {
      ...
      steps: {
        requirements:
          "من فضلك، تواصل مع مزود خدمة الاستضافة لديك لإصلاح الأخطاء!",
      ...
      requirements: {
        ...
        executable:
          "ان الملف التنفيذى ل PHP CLI غير معرف او لا يعمل او ان اصداره ليس {php_version} او اعلى منه, من فضلك اطلب من شركه الاستضافه تعيين متغير بيئة PHP_BINARY أو PHP_PATH بشكل صحيح.\n",
      },
      database: {
      ...
      error: {
        php_version:
          "حدث خطأ: اطلب من المتعهد مزود الخدمه ان يستخدم PHP {php_version} او اعلى منه لكلا من HTTP و CLI",
        connection:
          "خطأ: لا يمكن الاتصال بقاعدة البيانات! من فضلك، تأكد من صحة المعلومات.",
      },
    },
    users: {
      plural: "العضويات",
      ...
      messages: {
        ...
        verified:
          "لم يتم التحقق من هذا الحساب ، لقد أرسلنا لك رسالة نصية قصيرة تحتوي على كود",
    ...
    auth: {
      ...
      messages: {
        "forget-password-code-sent":
          "لفد تم ارسال رمز استعادة كلمة المرور على هاتفك الجوال",
        "email-verification-sent":
          "لفد تم ارسال رمز التفعيل على بريدك الالكتروني",
      },
      emails: {
        "forget-password": {
  ...
  en: {
    ...
    verification: {
      ...
      is_verified: "Your Account has been verified successfully",
      attributes: {
        user_id: "User",
        phone: "Phone",
        code: "Code",
    ...
    statistics: {
      index: "Statistic",
      more_info: "More Info",
      verified: "Verified Stores",
      active: "Active Stores",
      not_active: "Not Active Stores",
      customers: "Customers",
      categories: "Categories",
      products: "Products",
      pending: "Pending Orders",
      final: "Completed Orders",
      shipping: "Orders assigned to shipping companies",
      latest_orders: "Latest Orders",
      last_orders_days: "Orders count in last 7 days",
      stores: "Stores",
      orders: "Orders",
      shippingCompanies: "Shipping Companies",
      totalSales: "Total Sales",
      latest_customers_register: "Latest Customers Register",
    ...
    settings: {
      ...
      notes: {
        social_facebook:
          "Please write your account name after (https: www.facebook.com) and please do not delete the link",
        social_twitter:
          "Please write your account name after (https: www.twitter.com) and please do not delete the link",
        social_instagram:
          "Please write your account name after (https: www.instagram.com) and please do not delete the link",
        social_youtube:
          "Please write your account name after (https: www.youtube.com) and please do not delete the link",
        keywords:
          "Please write Keywords separated by (,) for example (one,two,three,..,..,etc)",
      },
      tabs: {
        main: "Main Settings",
    ...
    admin: {
      auth: {
        ...
        forget: {
          ...
          info: "Enter your email to reset your password",
          email: "Email",
          submit: "Request",
          cancel: "Cancel",
        },
    ...
    chats: {
      singular: "Chat",
      plural: "Chats",
      empty: "There are no chats yet.",
      count: "Chats count",
      search: "Search",
      select: "Select Chat",
      perPage: "Chats Per Page",
      ...
      messages: {
        created: "The chat has been created successfully.",
        updated: "The chat has been updated successfully.",
        deleted: "The chat has been deleted successfully.",
        images_note: "Supported types: jpeg, png,jpg | Max File Size{10MB}",
      },
      attributes: {
        name: "Chat Name",
      ...
      dialogs: {
        delete: {
          title: "Warning !",
          info: "Are you sure you want to delete the chat?",
          confirm: "Delete",
          cancel: "Cancel",
        },
      },
    ...
    users: {
      ...
      messages: {
        ...
        verified:
          "This account is not verified,we have sent you an sms with code",
    ...
    auth: {
      ...
      messages: {
        "forget-password-code-sent":
          "The reset password code was sent to your phone number.",
      },
      emails: {
        "forget-password": {
